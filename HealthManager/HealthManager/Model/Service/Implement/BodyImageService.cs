...
{
    internal class BodyImageService : IBodyImageService
    {
        /// <summary>
        ///     体格登録
        /// </summary>
        ...
        /// <returns></returns>
        public bool RegistBodyImage(string base64String)
        {
        ...
        /// <param name="base64String"></param>
        /// <returns></returns>
        public bool UpdateBodyImage(int id, string base64String)
        {
            var model = new BodyImageModel
            {
                Id = id,
        ...
        public BodyImageModel GetBodyImage()
        {
            using (var db = new SQLiteConnection(DbConst.DbPath))
            {
        ...
        public List<BodyImageModel> GetBodyImageList()
        {
            using (var db = new SQLiteConnection(DbConst.DbPath))
            {
